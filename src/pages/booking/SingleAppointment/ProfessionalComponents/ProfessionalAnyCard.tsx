...
const ProfessionalAnyCard = ({ title, customClass, subTitle, onclick, customHeight, customWidth, avatarIcon }: Props) => {
    return (
        <>
            <div className={`border-2 border-primary rounded-[10px] px-2 py-[15px] cursor-pointer ${customClass} ${customHeight ? customHeight : 'h-[174px]'}`}  onClick={onclick}>
