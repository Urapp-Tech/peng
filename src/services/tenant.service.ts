...
const getTenantWithController = () => {
  ...
  return () => {
    ...
    return axiosInstance.get<GetTenantDetailsResponse>(`/app/shop/view/${tenant}`, {
...
const getTenantConfigWithController = () => {
  ...
  return () => {
    ...
    return axiosInstance.get<GetTenantConfigResponse>(`/app/config/view/${tenant}`, {
...
const deviceRegistrationWithController = () => {
  ...
  return (deviceData: DeviceRegistration) => {
    ...
    return axiosInstance.post(`/app/app-user-device/register-device`, deviceData, {
