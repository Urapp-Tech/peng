...
const MainTabs = () => {
    ...
    const handleClick = () => {
        ...
        navigate('/booking/professional'); // Navigate to the login route
      };
    return (
        ...
        <Tabs defaultValue="account" className="w-full">
                ...
                <MainHeading title="Select Professional"/>
                    ...
                    <div className="w-full flex justify-between items-center flex-wrap" >
                        <ImageBtn title="Selena Swift" ratingTxt="4.9" ratingIcon={assets.images.rank} avatarIcon={assets.images.avatar} category="Beautician" customClass="mr-[5px] mb-[10px] " />
                        <IconButtons title="Select Professional Per Service" avatarIcon={assets.images.service} onclick={handleClick} customClass="mr-[5px] mb-[10px]"/>
