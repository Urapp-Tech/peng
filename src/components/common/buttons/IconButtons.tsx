...
const IconButtons = ({ title, customClass, subTitle, onclick, customHeight, customWidth, avatarIcon }: Props) => {
    return (
        <>
            <div className={`border-2 border-primary rounded-[10px] px-2 py-[15px]  ${customClass} ${customWidth ? customWidth : 'w-[32%]'} ${customHeight ? customHeight : 'h-[174px]'}`}  onClick={onclick}>
